...
const dict<string, keyset<string>> INFERRED_RELATIONSHIPS = dict[
  ...
  'array_creation_expression.array_creation_members' => keyset[
    ...
    'list<list_item<array_creation_expression>|list_item<binary_expression>|list_item<function_call_expression>|list_item<literal>|list_item<object_creation_expression>>',
    ...
    'list<list_item<array_intrinsic_expression>|list_item<collection_literal_expression>|list_item<darray_intrinsic_expression>|list_item<dictionary_intrinsic_expression>|list_item<function_call_expression>|list_item<keyset_intrinsic_expression>|list_item<literal>|list_item<varray_intrinsic_expression>|list_item<vector_intrinsic_expression>>',
    'list<list_item<array_intrinsic_expression>|list_item<darray_intrinsic_expression>|list_item<dictionary_intrinsic_expression>|list_item<keyset_intrinsic_expression>|list_item<literal>|list_item<varray_intrinsic_expression>|list_item<vector_intrinsic_expression>>',
  ...
  'function_call_expression.function_call_argument_list' => keyset[
    ...
    'list<list_item<array_creation_expression>|list_item<decorated_expression>>',
    'list<list_item<array_creation_expression>|list_item<decorated_expression>|list_item<prefix_unary_expression>|list_item<variable>>',
    'list<list_item<array_creation_expression>|list_item<decorated_expression>|list_item<token:name>>',
    ...
    'list<list_item<array_intrinsic_expression>|list_item<decorated_expression>|list_item<function_call_expression>|list_item<literal>|list_item<prefix_unary_expression>>',
    'list<list_item<array_intrinsic_expression>|list_item<decorated_expression>|list_item<literal>>',
    'list<list_item<array_intrinsic_expression>|list_item<decorated_expression>|list_item<literal>|list_item<prefix_unary_expression>>',
    'list<list_item<array_intrinsic_expression>|list_item<decorated_expression>|list_item<literal>|list_item<variable>>',
    'list<list_item<array_intrinsic_expression>|list_item<decorated_expression>|list_item<prefix_unary_expression>|list_item<variable>>',
    'list<list_item<array_intrinsic_expression>|list_item<decorated_expression>|list_item<token:name>>',
    'list<list_item<array_intrinsic_expression>|list_item<decorated_expression>|list_item<variable>>',
    ...
    'list<list_item<conditional_expression>|list_item<literal>|list_item<variable>>',
    'list<list_item<darray_intrinsic_expression>>',
    'list<list_item<darray_intrinsic_expression>|list_item<decorated_expression>>',
    ...
    'list<list_item<decorated_expression>|list_item<shape_expression>>',
    ...
    'list<list_item<decorated_expression>|list_item<tuple_expression>>',
    ...
    'list<list_item<dictionary_intrinsic_expression>|list_item<subscript_expression>>',
    ...
    'list<list_item<pipe_variable>>',
    'list<list_item<postfix_unary_expression>>',
    'list<list_item<postfix_unary_expression>|list_item<scope_resolution_expression>|list_item<subscript_expression>>',
  ...
  'intersection_type_specifier.intersection_left_paren' => keyset[
    'token:(',
  ],
  'intersection_type_specifier.intersection_right_paren' => keyset[
    'token:)',
  ],
  'intersection_type_specifier.intersection_types' => keyset[
    'list<list_item<simple_type_specifier>>',
  ],
  ...
  'script.script_declarations' => keyset[
    ...
    'list<do_statement|echo_statement|end_of_file|expression_statement|markup_section|try_statement>',
  ...
  'union_type_specifier.union_left_paren' => keyset[
    'token:(',
  ],
  'union_type_specifier.union_right_paren' => keyset[
    'token:)',
  ],
  'union_type_specifier.union_types' => keyset[
    'list<list_item<simple_type_specifier>>',
  ],
  ...
  'vector_intrinsic_expression.vector_intrinsic_members' => keyset[
    ...
    'list<list_item<dictionary_intrinsic_expression>|list_item<keyset_intrinsic_expression>|list_item<vector_intrinsic_expression>>',
    'list<list_item<dictionary_intrinsic_expression>|list_item<literal>>',
    'list<list_item<dictionary_intrinsic_expression>|list_item<literal>|list_item<vector_intrinsic_expression>>',
    'list<list_item<dictionary_intrinsic_expression>|list_item<vector_intrinsic_expression>>',
    'list<list_item<function_call_expression>>',
