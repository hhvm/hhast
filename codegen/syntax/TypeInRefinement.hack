 ...
 *
 * @generated SignedSource<<41e5b57beb5db5d41796c58d6cd99fe7>>
 */
...
final class TypeInRefinement extends Node {
  ...
  public function withType(TypeConstant $value): this {
    if ($value === $this->_type) {
      return $this;
    }
    return new static(
   ...
   * @return TypeConstant
   */
  public function getType(): TypeConstant {
    return TypeAssert\instance_of(TypeConstant::class, $this->_type);
  }

  /**
   * @return TypeConstant
   */
  public function getTypex(): TypeConstant {
    return $this->getType();
  }
}
