 ...
 *
 * @generated SignedSource<<79661b86e890455006f0efb0d221a251>>
 */
...
final class VectorTypeSpecifier extends Node implements ITypeSpecifier {
  ...
  public static function fromJSON(
    ...
    $keyword = Node::fromJSON(
      ($json['vector_type_keyword']) as dict<_, _>,
      $file,
      $offset,
      $source,
      'VecToken',
    ...
    $left_angle = Node::fromJSON(
      ($json['vector_type_left_angle']) as dict<_, _>,
      $file,
      $offset,
      $source,
      'LessThanToken',
    ...
    $type = Node::fromJSON(
      ($json['vector_type_type']) as dict<_, _>,
      $file,
      $offset,
      $source,
      'ITypeSpecifier',
    ...
    $trailing_comma = Node::fromJSON(
      ($json['vector_type_trailing_comma'] ?? dict['kind' => 'missing'])
        as dict<_, _>,
      $file,
      $offset,
      $source,
    ...
    $right_angle = Node::fromJSON(
      ($json['vector_type_right_angle']) as dict<_, _>,
      $file,
      $offset,
      $source,
      'GreaterThanToken',
